...
- 分支 tip（含报告）：`d3eac2b11d5b187db430b9078a2fa9fe00dd0cf7`
- 合并提交（`main`，`--no-ff`）：`9b4daa5b07db92eaaaa81ae7be0e0b30a8828afc`；合并后 `main` 运行 #307 绿 824 项 0 失败（G876）
- 提交数：5 个代码提交（子项 A／B／C／D 各一 + 子项 B 的一个推 CI 前降险修正）+ 1 个报告提交（分支）+ 合并提交 + 本回填提交（`main`）
...
| 6 | `d3eac2b11d5b187db430b9078a2fa9fe00dd0cf7` | — | docs：自验报告与变更清单（#306 一次绿 824 项 0 失败） |
| 合并 | `9b4daa5b07db92eaaaa81ae7be0e0b30a8828afc` | — | Merge IC-153（父提交 `681cf06` 与 `d3eac2b`） |
